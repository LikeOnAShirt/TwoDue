    ...
    <div class="accordion" id="friendAccordion" style="padding-bottom: 15px">
        <c:forEach items="${friendList}" var="friend">
            <div class="accordion-item">
                <h2 class="accordion-header" id="heading${friend.friendemail}">
                    <button class="accordion-button collapsed" style="background-color: #8EAA93" type="button" data-bs-toggle="collapse" data-bs-target="#collapse${friend.friendemail}" aria-expanded="false" aria-controls="collapse${friend.friendemail}">
                            ${friend.friendemail}
                    </button>
                </h2>
                <div id="collapse${friend.friendemail}" class="accordion-collapse collapse" style="background-color: #cccccc" aria-labelledby="heading${friend.friendemail}" data-bs-parent="#friendAccordion">
